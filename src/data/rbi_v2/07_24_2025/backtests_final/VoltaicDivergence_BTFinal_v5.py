        ...
        # Short setup: bearish divergence (lower price low but higher volatility)
            ...
            if (current_close < lower_bb and current_rsi < 50 and 
                ...
                if position_size > 0:
                    ...
                    tp_price = max(0.01, current_close - (self.rr_ratio * (stop_loss - current_close)))
                    if tp_price < current_close < stop_loss:
                        ...
                        print(f"🌙 MOON DEV SHORT ORDER REJECTED! Invalid TP/SL levels (TP: {tp_price}, Current: {current_close}, SL: {stop_loss})")
