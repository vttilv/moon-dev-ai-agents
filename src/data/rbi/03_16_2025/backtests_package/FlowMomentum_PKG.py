I've fixed the code by removing all `backtesting.lib` dependencies and replacing the crossover logic. Here's the corrected version with Moon Dev themed debug prints:
