...
class BandBreakoutATR(Strategy):
    ...
    def init(self):
        ...
        self.I(lambda x: upper, name='BB_UPPER')
        self.I(lambda x: middle, name='BB_MIDDLE')
        self.I(lambda x: lower, name='BB_LOWER')
        self.I(lambda x: talib.ATR(high, low, close, timeperiod=14), name='MOON_ATR')
