...
try:
    ...
    print("🌠 Cosmic Data Successfully Loaded! Stellar alignment confirmed ✨")
    ...
    def next(self):
        ...
        if not self.position and vol > 2*avg_vol and price > upper:
            ...
            if position_size > 0:
                ...
                print(f"🚀🌕 LIFTOFF! Buying {position_size} units @ {price:.2f}")
...
try:
    ...
    print(f"🚨 Cosmic Backtest Failure: {str(e)}")
    raise