        ...
        if not self.position:
            ...
            if current_close > upper_band and self.data.High[-1] >= self.swing_high[-1]:
                ...
                if stop_distance > 0:
                    ...
                    print(f"🌙🚀 MOON DEV LONG ENTRY @ {current_close:.2f}! Cluster Breakout Confirmed! TP: {self.swing_high[-1]:.2f} 🌕")
            ...
            # Short entry logic
                ...
                if stop_distance > 0:
                    ...
                    print(f"🌙🌌 MOON DEV SHORT ENTRY @ {current_close:.2f}! Liquidation Zone Activated! TP: {self.swing_low[-1]:.2f} 🌠")
