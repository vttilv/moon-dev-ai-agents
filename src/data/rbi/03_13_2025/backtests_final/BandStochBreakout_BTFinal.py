The code you provided is almost complete, but there are a few technical issues that need to be fixed. I'll address them while keeping the strategy logic intact. Here's the fully debugged and corrected version of your code:
