...
class VolSpikeReversion(Strategy):
    def init(self):
        ...
        # VVIX SMA
        self.vvix_sma = self.I(talib.SMA, self.data.vvix, timeperiod=20)
        
        # Volume averages
        self.vix_vol_avg = self.I(talib.SMA, self.data.vix_volume, timeperiod=20)
        self.spx_vol_avg = self.I(talib.SMA, self.data.spx_volume, timeperiod=20)
        
        # SPX low
        self.spx_low = self.I(talib.MIN, self.data.spx_close, timeperiod=20)
