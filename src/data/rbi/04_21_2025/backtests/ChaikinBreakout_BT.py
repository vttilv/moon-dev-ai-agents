        ...
        if current_close > high_20 and cmf > 0:
            ...
            if risk > 0:
                ...
                if size > 0:
                    ...
                    print(f"🌙🚀 MOON DEV LONG! Entry: {current_close:.2f} | Size: {size} | Risk: {risk:.2f} | TP: {tp:.2f}")
            ...
            if risk > 0:
                ...
                if size > 0:
                    ...
                    print(f"🌙📉 MOON DEV SHORT! Entry: {current_close:.2f} | Size: {size} | Risk: {risk:.2f} | TP: {tp:.2f}")
