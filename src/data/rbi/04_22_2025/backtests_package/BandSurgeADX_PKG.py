        ...
        if not self.position:
            ...
            if (current_close > current_upper and 
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        ...
                        print(f"🌕🚀 MOON SHOT LONG! Entry: {current_close:.2f} | Size: {position_size} | SL: {stop_loss:.2f} | TP: {tp_price:.2f}")
            ...
            # Short entry logic
                ...
                if risk_per_share > 0:
                    ...
                    if position_size > 0:
                        tp_price = current_close - 2 * risk_per_share
                        print(f"🌑🌌 DARK MOON SHORT! Entry: {current_close:.2f} | Size: {position_size} | SL: {stop_loss:.2f} | TP: {tp_price:.2f}")
