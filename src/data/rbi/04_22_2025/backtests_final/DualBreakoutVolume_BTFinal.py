    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (price > self.sma20[-1] and 
                ...
                risk = price - sl
                if risk <= 0:
                    print("🌙⚠️ INVALID RISK | Long Risk:", risk, "| Cosmic Alignment Failed! 🌠")
                    return
                ...
                if position_size > 0:
                    ...
                    print(f"🌙🚀 LONG ENTRY | Size: {position_size} | Price: {price:.2f} | SL: {sl:.2f} | TP: {tp:.2f} | Moon Rocket Activated! 🌕")
            ...
            # Short entry condition
                ...
                risk = sl - price
                if risk <= 0:
                    print("🌙⚠️ INVALID RISK | Short Risk:", risk, "| Black Hole Detected! 🕳️")
                    return
                ...
                if position_size > 0:
                    ...
                    print(f"🌙🌑 SHORT ENTRY | Size: {position_size} | Price: {price:.2f} | SL: {sl:.2f} | TP: {tp:.2f} | Dark Matter Engaged! 🕳️")
